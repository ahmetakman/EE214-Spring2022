...
\begin{table}[H]
    ...
    \end{center}
\end{table}
It can be said that different from passive band-pass filters, active filters also have a positive gain value. This means the specified frequencies also can be amplified with an active filter.
\subsubsection{b)}
