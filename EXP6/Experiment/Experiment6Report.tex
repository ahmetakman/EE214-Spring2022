...
\begin{itemize}
    ...
    \item After running the test, magnitude vs frequency plot is obtained. 
...
\subsubsection{a.}
In this step, circuit in Step 3 is used. For this step, a square wave at the resonant frequency where magnitude response is equal to 1 is applied and then input and output voltages are plotted in Figure 10.
...
\end{figure} 
Since there is a capacitor at the load,the capacitor discharges in the negative cycle of the input. Therefore, \(V_{01}\)(\(V_{out}\)) is measured as a sine wave while \(V_{02}\) is 0 at the negative cycle.
